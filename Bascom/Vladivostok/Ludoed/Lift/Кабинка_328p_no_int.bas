...
If Door = 0 And Luck = 0 Then
 If Play_up = 0 Or Flag_uart = 1 Then
  Waitms 80
  If Play_up = 0 Or Flag_uart = 1 Then
  Waitms 300 : Print ; "SU" : Flag_uart = 0 : Reset Flag_plan : Int_off : Up_lift       'start up
  End If
 Else
  Stop_data
 End If
 ...
 Waitms 80
  If Play_down = 0 Or Flag_uart = 2 Then
  Waitms 300 : Print ; "SD" : Flag_uart = 0 : Reset Flag_plan : Int_off : Down_lift       'start down
  End If
 Else
  Stop_data
 End If
...
Do
Set Svet
If Play_up = 0 Or Stope = 0 Or Door = 1 Or Luck = 1 Then
Waitms 20
If Play_up = 0 Or Stope = 0 Or Door = 1 Or Luck = 1 Then
...
End If
 End If
Pologenie
If Stope = 0 Or Door = 1 Or Luck = 1 Then
Waitms 20
If Stope = 0 Or Door = 1 Or Luck = 1 Then
Stop_lift : Exit Do
End If
