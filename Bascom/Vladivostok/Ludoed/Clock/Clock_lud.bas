...
Const St_cp = 1 : Config Portc.1 = Output : Reset Portc.1
Wait 2
Reset Mr
...
If Vk = 0 Then
Set Mr
Level1 = 9 : Level2 = 5 : Level3 = 9 : 595
Set T
Do
If Level3 = 2 Then
 Set Zni : If Tb = 0 Then Exit Do
 End If
If Level3 = 3 Then
Do
...
If Tb = 0 Then
 Set An : Reset Toch
 Else
 Ana = 0 : Reset An : Level2 = 0 : Level3 = 3 : Level1 = 0 : 595 : Set Toch : Exit Do
 End If
...
If T = 1 And H = 0 Then
Incr S : Set Toch : Ti = 1 : Print "hor= " ; Level1 ; "; min= " ; M ; "; sec= " ; S
If S = 60 Then
S = 0 : Incr M
If M = 60 Then
